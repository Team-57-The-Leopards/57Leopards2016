...
private:
	...
	std::shared_ptr<JoystickButton> btnRollersOutStop;
	std::shared_ptr<JoystickButton> btnRollersInStop;
	std::shared_ptr<JoystickButton> btnRollersOut;
	std::shared_ptr<JoystickButton> btnRollersIn;
	std::shared_ptr<JoystickButton> btnIntakeUp;
